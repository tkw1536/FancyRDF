...
final class UriReference
{
    ...
    /**
     * RFC 3987: RFC 3986 set plus ucschar and iprivate ranges.
     * Each Unicode range is in its own character class to avoid PCRE mis-parsing
     * adjacent \x{2FFFD}\x{30000}-\x{3FFFD} as a range 2FFFD-30000.
     */
